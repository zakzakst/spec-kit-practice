...
8. **Generate Verification Report**
   ...
   **Final Assessment**
   - CRITICAL がある: `X 件の critical issue が見つかりました。archive 前に修正してください。`
   - WARNING のみ: `critical issue はありません。考慮すべき warning が Y 件あります。archive 準備完了です。`
   - 問題なし: `すべてのチェックに合格しました。archive 準備完了です。`
